...
> Translate English markdown documents to Japanese, preserving code blocks
...
3. **Validate**:
   ...
   python3 skills/mango-svip/scripts/validate_workflow.py projects/md_en2ja/workflows/<name>.yml
   ```
