...
export interface Task {
  ...
  // which is where nearly every real build runs. Spec 114: the WORKFLOW-YAML slice of what it reports
  // also fails the phase (orchestrator.ts); the rest is still advisory, hence the wording below.
  strayNote?: string;
