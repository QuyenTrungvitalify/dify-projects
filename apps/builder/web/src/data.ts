/* ============================================================
   data.ts — sample content for the Dify Workflow Builder shell
   Domain: Eiken / stem_proofread (ported from data.jsx).
   lat4-ui swaps these for live /api responses.
   ============================================================ */
...
export const RUN_DETAIL: Record<PhaseKey, RunDetail> = {
  analyze: {
...
// ---- artifact content ----
export const SPEC_MD = `# Spec — Add JP grammar step
...
export const LINTERS_FAIL: Linter[] = [
  { name: 'schema-validate',   pass: true,  msg: 'ok' },
  { name: 'dead-node-check',   pass: true,  msg: '0 orphans' },
