...
const EN: Dict = {
  ...
  updateCheckoutFailed: 'Could not switch to the main branch — this copy probably has local edits. Restore them (or contact the admin) and try again.',
...
const JA: Dict = {
  ...
  updateCheckoutFailed: 'main ブランチに切り替えられませんでした — ローカルで変更されたファイルがある可能性があります。元に戻す（または管理者に連絡）してから、もう一度お試しください。',
