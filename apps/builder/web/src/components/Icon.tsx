...
export const I: Record<string, Glyph> = {
  ...
  bell:       (p) => <Svg {...p}><path d="M18 16H6c1.3-1.3 1.9-2.4 1.9-4.7V9.2a4.1 4.1 0 0 1 8.2 0v2.1c0 2.3.6 3.4 1.9 4.7z" /><path d="M10.3 19a1.8 1.8 0 0 0 3.4 0" /></Svg>,
  bellOff:    (p) => <Svg {...p}><path d="M18 16H6c1.3-1.3 1.9-2.4 1.9-4.7V9.2a4.1 4.1 0 0 1 8.2 0v2.1c0 2.3.6 3.4 1.9 4.7z" /><path d="M10.3 19a1.8 1.8 0 0 0 3.4 0" /><path d="M4.5 3.5l15 17" /></Svg>,
};
