...
2. Pick pattern:
      ...
      cp templates/patterns/file-iteration.yml projects/my_app/workflows/main.yml

3. Edit (VS Code autocomplete from JSON Schema):
...
| 1.C | ✅ | 7 patterns trong `templates/patterns/` |
