...
|--------------|------------|-----------------|----------------------|--------------|-----------------|-------|
| md_to_docx   | ✅         | ✅              | ❌ stripped          | ❌ stripped  | ✅              | Best for human visual review; inline formatting renders in Word. Verified via [test_docx_highlight.yml](../projects/eiken_stem_proofread/workflows/test_docx_highlight.yml). |
| md_to_xlsx   | ❌ stripped | ⚠️ literal `~~` | ❌ stripped          | ❌ stripped  | ✅ structure    | No inline formatting reaches Excel cells. Whitespace also collapses (see [constraints.md §5](../skills/mango-svip/references/constraints.md)). Verified via [test_xlsx_highlight.yml](../projects/eiken_stem_proofread/workflows/test_xlsx_highlight.yml). |
...
turn this file into an index (per spec 007 Q7.1).
